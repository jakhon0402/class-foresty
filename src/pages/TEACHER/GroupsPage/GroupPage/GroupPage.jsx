...
import { Spinner, Tabs, Tab, Badge } from "@nextui-org/react";
...
import GroupMonthsPage from "./GroupLessonsPage/GroupMonthsPage";
import GroupPaymentsPage from "./GroupPaymentsPage";
import GroupTeacherPayments from "./GroupTeacherPayments";
...
const GroupPage = () => {
  ...
  const { group, loading } = useSelector((state) => state.tgroups);
