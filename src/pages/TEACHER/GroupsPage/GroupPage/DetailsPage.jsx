...
const DetailsPage = ({ group }) => {
  ...
  const { teacher, lessonTimes } = useSelector((state) => state.tgroups);
  ...
  return (
    <div className='flex flex-col w-full'>
      <div className='flex flex-row justify-around w-full gap-5 flex-wrap'>
        ...
        <div className='flex flex-col w-[200px] min-h-[250px] py-8 gap-3 bg-foresty-white dark:bg-forestydark-500 rounded-[30px] justify-between items-center'>
          <Avatar
          ...
          <span className='text-[12px] font-bold text-forestydark-100'>
            {teacher?.teacher?.teacher?.user?.username}
          </span>
          {/* <button
